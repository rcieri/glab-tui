...
pub enum Event {
    ...
    Mouse(MouseEvent),
    Resize(u16, u16),
    PipelineJobs(u64, Vec<crate::gitlab::pipelines::JobItem>),
    IssuesFetched(Vec<crate::gitlab::issues::Issue>),
    MrsFetched(Vec<crate::gitlab::mr::MergeRequest>),
    PipelinesFetched(Vec<crate::gitlab::pipelines::PipelineItem>),
    ...
    JobsTabFetched(u64, Vec<crate::gitlab::pipelines::JobItem>),
