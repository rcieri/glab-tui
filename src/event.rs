...
pub enum Event {
    ...
    Mouse(MouseEvent),
    Resize(u16, u16),
    PipelineJobs(u64, Vec<crate::domain::pipelines::JobItem>),
    IssuesFetched(Vec<crate::domain::issues::Issue>),
    MrsFetched(Vec<crate::domain::mr::MergeRequest>),
    PipelinesFetched(Vec<crate::domain::pipelines::PipelineItem>),
    ...
    JobsTabFetched(u64, Vec<crate::domain::pipelines::JobItem>),
